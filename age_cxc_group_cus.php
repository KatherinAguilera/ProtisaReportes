...
<table width="80%" border="0" align="center">
	<tr>
	<tr>
	<td><h6>Cartera Agrupada por Cliente Drypers</h6></td>
	</tr>
		<td align='left'> <h5>Selecione fecha de corte: </h5></td>
			<form name="consulta" action="age_cxc_group_cus.php" method="post" onsubmit="return valida_envia(this);">
	...
	<?
		if( isset($_POST['cut_date']) )
		{
			echo"
				...
				<tr>
				<td align='right'><h3><input type='button' value='Exportar a Excel' class='excel' onclick=\"location.href='./age_cxc_group_cus_excel.php?cut_date=".$_POST['cut_date']."'\" name='excel'/></h3></td>
				</tr>
				";
		}
	?>
