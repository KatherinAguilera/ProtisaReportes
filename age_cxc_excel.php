...
header ("Content-Disposition: attachment; filename=\"carteraedadescsv\"" );
//echo $_GET['cut_date'];
...
echo "COD,CLIENTE,FACTURA,F. DOC,F. VEN,D. MORA,SALDO,CORRIENTE,1 A 10,11 A 90,91 A 180,>180,\n";
