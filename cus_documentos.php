...
<table width="80%" border="0" align="center">
	<tr>
		<td align='left'>
		<td><h6>Detalle de Factura Drypers</h6>
			<form name="consulta" action="cus_documentos.php" method="post" onsubmit="return valida_envia(this);">
	...
	<?
		if( isset($_POST['doc_no']) )
		{
			echo"
				...
				<tr>
				<td align='left'><h3><input type='button' value='Exportar a Excel' class='excel'onclick=\"location.href='./cus_documentos_excel.php?doc_no=".$_POST['doc_no']."'\" name='excel'/></h3>
                 </tr>
				";
		}
	?>
