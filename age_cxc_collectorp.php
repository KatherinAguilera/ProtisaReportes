...
<html lang="es">
<head>
	<title>Edades de Cartera por Cobrador</title>
...
<br>
<td><h6>Cartera Por Cobrador Protisa</h6>
<br>
		 ...
		 if ( $existe )
		 {
			echo"
				<table width='80%' border='0' align='center'>
					<tr>
						<td align='left'>
						<form name='consulta' action='age_cxc_collectorp.php' method='post' onsubmit='return valida_envia(this);'>
						<select name='sal_no'>
							<option value=''></option>				
				";
...
?>
	...
	<?
		if( isset($_POST['sal_no']) )
		{
			echo"
				<tr>
					<td colspan='2'><h3> Cartera por Cobrador: $Salesm_no, $ars_slspsn_name[0] </h3></td>
				</tr>
				<tr>
					<td colspan='2' align='center'><h4> Generado: ".date('d-m-Y H:i:s')."</h4></td>
				</tr>
			<tr>
				<td align='left'><h3><input type='button' value='Exportar a Excel' class='excel'onclick=\"location.href='http://localhost/reportesc/age_cxc_collector_excel.php?sal_no=".$_POST['sal_no']."'\" name='excel'/></h3>
                </tr>
