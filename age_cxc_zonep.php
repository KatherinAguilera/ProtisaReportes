...
<html lang="es">
<head>
	<title>Edades de Cartera por Zona</title>
		...
		// Se define la consulta que va a ejecutarse, como en sql
		 $sql = 
				"
					...
					WHERE      (C.curr_cd = 'PES') AND (C.vend_no = '$zone_desc')
...
<br>
<td><h6>Cartera Por Zona Protisa</h6></td>
<br>
<div class="resultadoc">
<table width="80%" border="0" align="center">
	<tr>
		<td align='left'>
			<form name="consulta" action="age_cxc_zonep.php" method="post" onsubmit="return valida_envia(this);">
			<select name="zone">
				<option value=""></option>				
				...
				<td>
			<td width="2%"><input type="submit" value="Consultar"></td>
			</td>
	...
	<?
		if( isset($_POST['zone']) )
		{
			echo"
				<tr>
					<td colspan='2'><h3> Cartera Zona: $zone_desc</h3></td>
				</tr>
				<tr>
				...
				<tr>
					<td align='left'><h3><input type='button' value='Exportar a Excel' class='excel'onclick=\"location.href='./age_cxc_zone_excel.php?zone=".$_POST['zone']."'\" name='excel'/></h3>
                </tr>
				";
		}
	?>
