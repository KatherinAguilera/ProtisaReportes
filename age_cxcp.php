...
<table width="75%" border="0" align="center">
	<tr>
	<tr>
		<td><h6>Cartera Por Edades Protisa</h6></td>
		</tr>
		<td align='left'> <h5>Selecione fecha de corte:</h5></td></div>
			<form  name="consulta" action="age_cxcp.php" method="post" onsubmit="return valida_envia(this);">
		<td width="5%"><input name="cut_date" type="text" title="DD/MM/YYYY" onclick="scwShow(this,this);" /></td>
			<td width="2%"><input type="submit" class="cal" value="Generar Consulta" />	</td></div>
			</form>
	...
	<?
		if( isset($_POST['cut_date']) )
		{
			echo"
				<tr>
					<td width='60%' align='left'><br><h3>Total Cartera por Edades - Corte de Documentos: ".$_POST['cut_date']."</h3></td>
				</tr>
				<tr>
					<td><h3> Fecha de Generación: ".date('d/m/Y h:i:s')."</h3></td>
				</tr>
				<tr>
					<td align='right'><h3><input type='button' value='Exportar a Excel' class='excel' onclick=\"location.href='./age_cxc_excel.php?cut_date=".$_POST['cut_date']."'\" name='excel'/></h3></td>
				</tr>
...
<div class="resultado">
<br>
<table width="90%" border="3" cellpadding="0" cellspacing="5" bordercolor="#DCF3A4" align='center'>
<!--<th>COD. PADRE</th>-->
<th>COD.</th>
<th>CLIENTE</th>
<!--<th>FP</th>-->
...
//	echo "<td>".$aro_curr_cd[$i]."</td>";
	...
	//1 a 10
	if( $d_cartera > 0 && $d_cartera < 11 && $arc_cus_no[$i] != 1289 && $arc_cus_no[$i] != 1029 && $arc_cus_no[$i] != 1280 && $arc_cus_no[$i] != 1003 && $arc_cus_no[$i] != 1292 && $arc_cus_no[$i] != 1294 && $arc_cus_no[$i] != 9997 && $arc_cus_no[$i] != 1006 )
	{
		echo "<td align='right'>".number_format($aro_amt[$i],2)."</td>";
		$edad1 += $aro_amt[$i];
	}
		...
		echo "<td align='right'>0.00</td>";
	//11 a 90
	if( $d_cartera > 10 && $d_cartera < 91 && $arc_cus_no[$i] != 1289 && $arc_cus_no[$i] != 1029 && $arc_cus_no[$i] != 1280 && $arc_cus_no[$i] != 1003 && $arc_cus_no[$i] != 1292 && $arc_cus_no[$i] != 1294 && $arc_cus_no[$i] != 9997 && $arc_cus_no[$i] != 1006 )
	{
		echo "<td align='right'>".number_format($aro_amt[$i],2)."</td>";
		$edad2 += $aro_amt[$i];
	}
		...
		echo "<td align='right'>0.00</td>";
	//91 a 180
	if( $d_cartera > 90 && $d_cartera < 181 && $arc_cus_no[$i] != 1289 && $arc_cus_no[$i] != 1029 && $arc_cus_no[$i] != 1280 && $arc_cus_no[$i] != 1003 && $arc_cus_no[$i] != 1292 && $arc_cus_no[$i] != 1294 && $arc_cus_no[$i] != 9997 && $arc_cus_no[$i] != 1006 )
	{
		echo "<td align='right'>".number_format($aro_amt[$i],2)."</td>";
		$edad3 += $aro_amt[$i];
	}
		...
		echo "<td align='right'>0.00</td>";
	//Más de 180
	if( $d_cartera > 180 && $arc_cus_no[$i] != 1289 && $arc_cus_no[$i] != 1029 && $arc_cus_no[$i] != 1280 && $arc_cus_no[$i] != 1003 && $arc_cus_no[$i] != 1292 && $arc_cus_no[$i] != 1294 && $arc_cus_no[$i] != 9997 && $arc_cus_no[$i] != 1006 )
	{
		echo "<td align='right'>".number_format($aro_amt[$i],2)."</td>";
		$edad4 += $aro_amt[$i];
	}
