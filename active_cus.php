...
<table width="80%" border="0" align="center">
	<tr>
		<td align='left'>
			<td><h6>Clientes Activos Drypers</h6>
			<form name="consulta" action="active_cus.php" method="post" onsubmit="return valida_envia(this);">
	...
	<?
		if( isset($_POST['cus_no']) || isset($_GET['cus_no']) )
		{
			echo"
				...
				<tr>
				<td align='right'><h3><input type='button' value='Exportar a Excel' class='excel' onclick=\"location.href='./active_cus_excel.php?cus_no=".$_POST['cus_no']."'\" name='excel'/></h3></td>
				</tr>
				";
		}
	?>
