...
{	
 ...
 odbc_close( $link );
	...
	<div class='edad'>
        ...
        <tr>
		<td align='center'><h3><input type='button' value='Exportar a Excel' class='excel'onclick=\"location.href='./age_cxc_cus_excel.php?cus_no=".$_POST['cus_no']."'\" name='excel'/></h3>
		</td>
		</tr>
		</div>
		</div>
...
<table width="80%" border="0" align="center">
	<tr>
		<td align='center'>
		<h6>Cartera Por Cliente Protisa</h6>
			<form name="consulta" action="age_cxc_cusp.php" method="post" onsubmit="return valida_envia(this);">
			<input class="fieldtext" type="text" size="6" maxlength="6" name="cus_no" placeholder="Digite codigo">
...
//	echo "<td>".$aro_doc_type[$i]."</td>";
	//Días de Mora
	if($d_cartera > 0)
		echo "<td  width='20 px' style='background-color:blue;'>".$d_cartera."</td>";
	else
