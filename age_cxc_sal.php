		...
		// Se define la consulta que va a ejecutarse, como en sql
		 $sql = 
				"
					...
					FROM   ARSLMFIL_SQL
					WHERE  (slspsn_no <> 999) AND (slspsn_no <> 100) AND (slspsn_no <> 108)
					ORDER BY slspsn_no
				";
		 // Se ejecuta la consulta y se guardan los resultados
		 ...
		 if ( $existe )
		 {
			echo"
				<table width='80%' border='0' align='center'>
					<tr>
						<td align='left'>
						<form name='consulta' action='age_cxc_sal.php' method='post' onsubmit='return valida_envia(this);'>
						<select name='sal_no'>
							<option value=''></option>				
				";
	...
	<?
		if( isset($_POST['sal_no']) )
		{
			echo"
				...
				<tr>
					<td align='left'><h3><input type='button' value='Exportar a Excel' class='excel'onclick=\"location.href='./age_cxc_sal_excel.php?sal_no=".$_POST['sal_no']."'\" name='excel'/></h3>
                </tr>
